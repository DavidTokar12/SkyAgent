...
result = agent.call_agent(
    query="""
There is a a bash script somewhere int the /workspaces/SkyAgent/examples(there is a rumour that it takes a long time to run it). Your job is to find this script, run it for a little bit, and report back to me once it generates a secret number or something.
"""
)
